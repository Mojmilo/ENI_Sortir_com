 ...
 */
final class Version20241120082413 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE output ADD status VARCHAR(255) NOT NULL, DROP status_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE output ADD status_id INT NOT NULL, DROP status');
        $this->addSql('ALTER TABLE output ADD CONSTRAINT FK_CCDE149E6BF700BD FOREIGN KEY (status_id) REFERENCES status (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
